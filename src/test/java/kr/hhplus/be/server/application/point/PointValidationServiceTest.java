...
class PointValidationServiceTest {
    ...
    void validateChargeAmount_Success() {
        assertThatCode(() -> validator.validate(BigDecimal.valueOf(1000), TransactionType.CHARGE))
    ...
    void validateChargeAmountTooLow() {
        assertThatThrownBy(() -> validator.validate(BigDecimal.valueOf(999), TransactionType.CHARGE))
    ...
    void validateChargeAmountTooHigh() {
        assertThatThrownBy(() -> validator.validate(BigDecimal.valueOf(100_001), TransactionType.CHARGE))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void validateUseAmount_Success() {
        assertThatCode(() -> validator.validate(BigDecimal.valueOf(100), TransactionType.USE))
                .doesNotThrowAnyException();
    }
    ...
    void validateUseAmountTooLow() {
        assertThatThrownBy(() -> validator.validate(BigDecimal.valueOf(99), TransactionType.USE))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void validateInvalidType() {
        ...
        assertThatThrownBy(() -> validator.validate(BigDecimal.valueOf(1000), invalidType))
                .isInstanceOf(IllegalArgumentException.class)
